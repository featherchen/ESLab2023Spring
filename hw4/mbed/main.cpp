...
#include "AcceleroService.h"

using namespace std::literals::chrono_literals;

const static char DEVICE_NAME[] = "HHHHHHHeartrate";
...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        acceleroXYZ(),
        accelero_service(ble, acceleroXYZ, AcceleroService::LOCATION_FINGER),
...
private:
    ...
    void update_accelero() {
        BSP_ACCELERO_AccGetXYZ(acceleroXYZ);

        accelero_service.updateaccelero(acceleroXYZ);
    }
